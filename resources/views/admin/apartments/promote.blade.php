            ...
            <div class="row text-center">
                ...
                <div class="col-4">
                    <div class="card">
                        ...
                        <div class="form-check-input d-flex">
                            <input class="form-check-input" type="radio" name="promotion" id="promotion1" value="1" checked>
                ...
                <div class="col-4">
                    <div class="card">
                        <h2>Prom 2</h2>
                        <div class="form-check-input d-flex">
                            <input class="form-check-input" type="radio" name="promotion" id="promotion2" value="2">
                ...
                <div class="col-4">
                    <div class="card">
                        <h2>Prom 3</h2>
                        <div class="form-check-input d-flex">
                            <input class="form-check-input" type="radio" name="promotion" id="promotion3" value="3">
